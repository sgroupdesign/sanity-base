          ...
          {block.testimonials?.map((testimonial: any, key: any) => (
            <CarouselItem key={key} className="">
              <div className="" key={key}>
                <div className="flex gap-x-20 gap-y-10 lg:items-end flex-col lg:flex-row">
                  <div className="basis-full lg:basis-3/4 flex flex-col gap-y-6">
                    <svg
                    ...
                    <p className="text-2xl lg:text-5xl font-normal leading-tight">
                      {testimonial.content}
                    </p>
                  </div>
                  <div className="w-full basis-full lg:basis-1/4">
                    <div className="flex gap-x-4 items-center">
                      <div className="w-20">
                        <div className="aspect-square rounded-full overflow-hidden flex flex-col items-center justify-center bg-gray-200">
                          {testimonial.picture ? (
                            <Image
