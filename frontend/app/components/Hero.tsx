  ...
  return (
    <section
      className={cn(
        ...
        block.layout == 'stacked' ? 'h-auto p-6' : 'h-[80vh]',
      )}
      ...
      >
        <div
          className={cn(
            ...
            stegaClean(block.alignItems) == 'justify' && 'h-full justify-between',

            stegaClean(block.layout) == 'stacked' && stegaClean(block.alignItems) == 'justify'
        ...
        >
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className={cn('flex gap-4', block.textAlign == 'center' && 'justify-center')}>
