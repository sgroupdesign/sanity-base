...
export default function Card(props: CardProps) {
  ...
  return (
    <div className="basis-full md:basis-1/2 lg:basis-1/3 pl-10 pb-10 group">
        ...
        {image && (
          ...
          >
            <CoverImage
              ...
              className="w-full h-full absolute inset-0 group-hover:scale-110 transition ease-in-out duration-500"
              width={600}
              height={600}
            />
          </div>
